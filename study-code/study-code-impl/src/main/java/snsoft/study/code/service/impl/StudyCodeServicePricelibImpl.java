...
import snsoft.plat.bas.busi.service.impl.DefaultFunctionService;
 ...
 */
@Service
public class StudyCodeServicePricelibImpl extends DefaultFunctionService<StudyPriceLib> implements StudyCodePricelibService {
    @Override
